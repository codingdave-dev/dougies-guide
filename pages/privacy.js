    ...
    <Grid container alignItems={"center"} direction={"column"}>
      ...
      >
        ...
        <Grid item container direction={"column"}>
          ...
          <Grid item className={classes.textWrapper}>
            <Typography variant={"body1"} className={classes.text}>
              Thank you for choosing to be part of our community at Dougies
              Guide (“Company”, “we”, “us”, or “our”). We are committed to
              ...
              contact us at dougiesguide@gmail.com.
            </Typography>
          </Grid>
          <Grid item className={classes.textWrapper}>
            <Typography variant={"body1"} className={classes.text}>
              When you visit our website https://dougiesguide.com (the
          ...
          <Grid item className={classes.textWrapper}>
            <Typography variant={"body1"} className={classes.text}>
              ...
              addresses; usernames; passwords; contact preferences; contact or
              authentication data; phone numbers; and other similar information.
            </Typography>
          </Grid>
          <Grid item className={classes.textWrapper}>
            <Typography variant={"body1"} className={classes.text}>
          ...
          <Grid item className={classes.textWrapper}>
            ...
            >
              ...
              will obtain your consent to use your name and the consent of the
              testimonial. If you wish to update, or delete your testimonial,
              please contact us at dougiesguide@gmail.com and be sure to include
          ...
          <Grid item className={classes.textWrapper}>
            ...
            >
              ...
              posting comments, contributions or other content to the Website)
              or otherwise interact with public areas of the Website, such
              personal information may be viewed by all users and may be
              publicly made available outside the Website in perpetuity. If you
              interact with other users of our Website and register for our
              Website through a social network (such as Facebook), your contacts
              ...
              our Website, and view your profile.
            </Typography>
          </Grid>
          ...
          <Grid item className={classes.textWrapper}>
            <Typography variant={"body1"} className={classes.text}>
              ...
              may email us at dougiesguide@gmail.com.
            </Typography>
          </Grid>
          ...
          <Grid item className={classes.textWrapper}>
            ...
            >
              ...
              employment, employment history and financial information - YES
            </Typography>
          </Grid>
          <Grid item className={classes.textWrapper}>
            <Typography
          ...
          <Grid item className={classes.textWrapper}>
            ...
            >
              ...
              level, job title as well as work history and professional
          ...
          <Grid item className={classes.textWrapper}>
            ...
            >
              ...
              drawn from any of the collected personal information listed above
              to create a profile or summary about, for example, an individual’s
              preferences and characteristics - YES
            </Typography>
          </Grid>
          ...
          <Grid item className={classes.textWrapper}>
            <Typography variant={"body1"} className={classes.text}>
              You may contact us by email at dougiesguide@gmail.com, or by
          ...
          <Grid item className={classes.textWrapper}>
            <Typography variant={"body1"} className={classes.text}>
              Dougies Guide has not disclosed or sold any personal information
              to third parties for a business or commercial purpose in the
              preceding twelve (12) months. Dougies Guide will not sell personal
          ...
          <Grid item className={classes.textWrapper}>
            <Typography variant={"body1"} className={classes.text}>
              ...
              to ask you to provide information so that we can match it with the
          ...
          <Grid item className={classes.textWrapper}>
            <Typography variant={"body1"} className={classes.text}>
              ...
              dougiesguide@gmail.com, or by referring to the contact details at
          ...
          <Grid item className={classes.textWrapper}>
            <Typography variant={"body1"} className={classes.text}>
              ...
              contact our Data Protection Officer (DPO), Dave Evans, by email at
              dougiesguide@gmail.com, by phone at 323 620 7662, or by post to:
            </Typography>
          </Grid>
          ...
          {/*HOW CAN YOOU REVIEW,UPDATE OR DELETE THE DATA WE COLLECT FROM YOU*/}
          <Grid item className={classes.textWrapper}>
            <Typography variant={"h6"} className={classes.subTitle}>
          ...
          <Grid item className={classes.textWrapper}>
            <Typography variant={"body1"} className={classes.text}>
              ...
              <a href="https://app.termly.io/notify/4d58cfd8-052d-40a9-babf-9bb2300015c8">
                here
              </a>
